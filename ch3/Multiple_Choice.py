...
# One benefit of giving these tests is that they are easy to mark, given an answer_num key.
# 이런 시험들이 주는 한 가지 이점이 있다면, 그것들은 표시 하기 쉬우며, 답을 준다.
# The other benefit is that students believe they have a one-in-five chance of getting the correct answer_num, assuming the multiple choice possibilities are A, B, C, D or E.
...
# i is the student response, then line N+i will contain the correct answer_num to that question).
